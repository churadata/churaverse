...
export interface ITransmitQueue {
  ...
  insert: <T extends SocketEmitOnlyActionType>(sendActionData: ActionFromServer<T>) => void
  insertAt: <T extends SocketEmitOnlyActionType>(playerId: string, sendActionData: ActionFromServer<T>) => void
  insertWithout: <T extends SocketEmitOnlyActionType>(playerId: string, sendActionData: ActionFromServer<T>) => void
}
